...
import { LiaFileImportSolid, LiaStreamSolid } from "react-icons/lia";
...
export default function CourseStatus() {
 return (
   <div id="wd-course-status" style={{ width: "350px" }}>
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <FaHome className="me-2 fs-5" /> Course Home Page </Button>
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <AiFillNotification className="me-2 fs-5" /> View Course Notifications </Button>
   </div> );}